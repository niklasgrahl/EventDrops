      ...
      selection.each(function (data) {
        ...
        if (typeof config.eventHover === 'function') {
          zoomRect.on('mousemove', function(d, e) {
            ...
            if(
              typeof config.eventLeave === 'function' &&
              lastHover &&
              (lastHover.tagName === 'circle' || lastHover.tagName === "rect") &&
              el !== lastHover
            ){
              config.eventLeave(lastHover);
            }
            lastHover = el;
            if (el.tagName !== 'circle' && el.tagName !== "rect") return;
